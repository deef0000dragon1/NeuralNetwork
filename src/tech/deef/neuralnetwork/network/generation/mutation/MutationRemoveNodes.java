...
public class MutationRemoveNodes {
	
	public static ArrayList<NetworkCalculationNode> removeNodes(Random rand,
			ArrayList<NetworkCalculationNode> nodes, int linkagesToChange) {
	...
	public static int calculateNumberOfNodesToRemove(int numberOfNodes, double mutatorValue, Random rand){
